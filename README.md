...
1. On the "Step 2: VPC with a Single Public Subnet" page give your VPC a meaningful name and specify the availability zone as 'a', i.e. select eu-west-1a from the pulldown.
...
```
6. Log in using the username and password you created in the startup script:
```sh
